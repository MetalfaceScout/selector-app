...
class Player {
    constructor(codename, avgMVPArray) {
        this.name = codename;
        this.avgMVP = avgMVPArray[0];
        this.avgMVPCommander = avgMVPArray[1];
        this.avgMVPHeavy = avgMVPArray[2];
        this.avgMVPScout = avgMVPArray[3];
        this.avgMVPAmmo = avgMVPArray[4];
        this.avgMVPMedic = avgMVPArray[5];
    }
